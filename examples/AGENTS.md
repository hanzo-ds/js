...
2. Examples are organized by client flavor and tailored to the corresponding runtime:
   - [`examples/node`](node) — examples for the Node.js client (`@hanzo/datastore-client`). These
   ...
   - [`examples/web`](web) — examples for the Web client (`@hanzo/datastore-client-web`). These
