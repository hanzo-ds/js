...
| Insert a UUID into a `UInt128` column          | [node/coding/insert_uuid_into_uint128.ts](node/coding/insert_uuid_into_uint128.ts)                                     | [web/coding/insert_uuid_into_uint128.ts](web/coding/insert_uuid_into_uint128.ts)                                     |
