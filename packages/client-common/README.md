...
Datastore protocol or gRPC over a proxy).
...
See
[Building specialized clients for alternative runtimes and protocols](https://github.com/hanzo-ds/js/blob/main/ALTERNATIVE_CLIENTS.md)
for the full guide.

## Changelog

See [`CHANGELOG.md`](https://github.com/hanzo-ds/js/blob/main/packages/client-common/CHANGELOG.md).
