export const EnvKeys = {
  host: "DATASTORE_CLOUD_HOST",
  username: "DATASTORE_CLOUD_USERNAME",
  password: "DATASTORE_CLOUD_PASSWORD",
  jwt_access_token: "DATASTORE_CLOUD_JWT_ACCESS_TOKEN",
  jwt_secret: "DATASTORE_CLOUD_JWT_SECRET",
};
...
export function getAuthFromEnv() {
  if (process.env["DATASTORE_TEST_ENVIRONMENT"] === "cloud") {
