 ...
 * only when the `DATASTORE_ANALYTICS_URL` env var is set, otherwise it stays
...
describe("oss-dependents / firecrawl", () => {
  ...
  function buildClient(analyticsConfigured: boolean): DatastoreClient | null {
