...
/**
 * Thrown when a Datastore type cannot be turned into a RowBinary reader —
...
export class RowBinaryTypeError extends Error {
  /** The full Datastore type string being compiled, when the throw site knows it. */
 ...
 * sorted by type NAME (Datastore's global ordering), and the server writes the
