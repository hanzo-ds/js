...
/**
 * Parse one Datastore type string and fold it into a {@link Reader}. Throws a
...
/** Resolves a Datastore type string to a reader — `typeStringToReader` or a cache wrapping it. */
export type TypeReaderResolver = (typeStr: string) => Reader<unknown>;

/**
 * Build an LRU-cached {@link typeStringToReader}. The full Datastore type
