...
const DEFAULT_LOG_PATH = "/tmp/datastore-client-cli.log";
const FALLBACK_LOG_FILENAME = "datastore-client-cli.log";

export function resolveLogPath(): string {
  const fromEnv = process.env["DATASTORE_CLIENT_CLI_LOG"];
